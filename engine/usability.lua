...
function usability.canUseSkill(skill, actor, target, context)
    ...
    -- Occasion is authored explicitly on every skill. This is the same closed
    -- vocabulary items use: battle, field, always, none. The loader rejects
    -- missing/unknown skill scopes, so runtime never derives occasion from a
    -- skill's cost or effect shape.
