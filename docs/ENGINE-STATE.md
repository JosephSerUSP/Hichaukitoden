...
- effect types: **12**
- trait codes: **23**
- meta keys: **5** (disciplines, intensityGrade, craftable, detect, detectLevel)
...
- items: **46** (consumablex14, equipmentx25, junkx3, questx4)
- skills: **15**, passives: **21**, states: **8**, roles: **13**, elements: **5**
