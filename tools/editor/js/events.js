        // --- EVENT CONTROLLERS ---
        var activeEventLocalScript = null;

        var eventModalDirty = false;
        ...
        var activeCmdCallback = null;
        var activeCmdOriginal = null;
        var cmdDialogDirty = false;
...
// Exports
window.rgb01ToHex = rgb01ToHex;
window.hexToRgb01 = hexToRgb01;
window.setEventColorFields = setEventColorFields;
window.openEventModal = openEventModal;
window.updateEventGraphicPreview = updateEventGraphicPreview;
window.openAssetPickerForEventSprite = openAssetPickerForEventSprite;
window.toggleEventLogicType = toggleEventLogicType;
window.closeEventModal = closeEventModal;
window.applyEventProperties = applyEventProperties;
window.deleteEventAtCoords = deleteEventAtCoords;
window.describeCommand = describeCommand;
window.makeMarkerRow = makeMarkerRow;
window.renderCommandList = renderCommandList;
window.renderChoiceBlock = renderChoiceBlock;
window.renderConditionalBlock = renderConditionalBlock;
window.openCommandModalForAdd = openCommandModalForAdd;
window.openCommandModalForEdit = openCommandModalForEdit;
window.populateCmdCommonEventsDropdown = populateCmdCommonEventsDropdown;
window.openAddCommandDialog = openAddCommandDialog;
window.openEditCommandDialog = openEditCommandDialog;
window.toggleCmdTypeFields = toggleCmdTypeFields;
window.closeCmdDialog = closeCmdDialog;
window.applyCmdDialog = applyCmdDialog;
window.initEventModalTemplates = initEventModalTemplates;
