        ...
        // and validation.
        var activeEngineTab = 'battleflow';
        var engineModalSnapshot = null;
...
// Exports
window.initSystemTab = initSystemTab;
window.buildBattleScreenPreview = buildBattleScreenPreview;
window.engineSnapshotStr = engineSnapshotStr;
window.openEngineModal = openEngineModal;
window.closeEngineModal = closeEngineModal;
window.buildEffectTypeRegistryEditor = buildEffectTypeRegistryEditor;
window.buildTraitCodeRegistryEditor = buildTraitCodeRegistryEditor;
window.setEngineTab = setEngineTab;
window.damagePopupConfigSnapshot = damagePopupConfigSnapshot;
window.openDamagePopupModal = openDamagePopupModal;
window.closeDamagePopupModal = closeDamagePopupModal;
