        ...
        const CONFIG_SCHEMA = {
            ...
            'windowLayout.headerSpacing':  { label: 'Header Spacing', min: 0 },
            'windowLayout.titleRect.x': { label: 'Title Rect X', type: 'number' },
            'windowLayout.titleRect.y': { label: 'Title Rect Y', type: 'number' },
            'windowLayout.titleRect.w': { label: 'Title Rect W', type: 'number' },
            'windowLayout.titleRect.h': { label: 'Title Rect H', type: 'number' },
            'windowLayout.titleMenu.x': { label: 'Title Menu X', type: 'number' },
            'windowLayout.titleMenu.y': { label: 'Title Menu Y', type: 'number' },
            'windowLayout.titleMenu.w': { label: 'Title Menu W', type: 'number' },
            'windowLayout.titleMenu.h': { label: 'Title Menu H', type: 'number' },
            'windowLayout.townOptions.x': { label: 'Town Options X', type: 'number' },
            'windowLayout.townOptions.y': { label: 'Town Options Y', type: 'number' },
            'windowLayout.townOptions.w': { label: 'Town Options W', type: 'number' },
            'windowLayout.townOptions.h': { label: 'Town Options H', type: 'number' },
            'windowLayout.treasure.x': { label: 'Treasure X', type: 'number' },
            'windowLayout.treasure.y': { label: 'Treasure Y', type: 'number' },
            'windowLayout.treasure.w': { label: 'Treasure W', type: 'number' },
            'windowLayout.treasure.h': { label: 'Treasure H', type: 'number' },
            'windowLayout.shopMain.x': { label: 'Shop Main X', type: 'number' },
            'windowLayout.shopMain.y': { label: 'Shop Main Y', type: 'number' },
            'windowLayout.shopMain.w': { label: 'Shop Main W', type: 'number' },
            'windowLayout.shopMain.h': { label: 'Shop Main H', type: 'number' },
            'windowLayout.menuLeft.x': { label: 'Menu Left X', type: 'number' },
            'windowLayout.menuLeft.y': { label: 'Menu Left Y', type: 'number' },
            'windowLayout.menuLeft.w': { label: 'Menu Left W', type: 'number' },
            'windowLayout.menuLeft.h': { label: 'Menu Left H', type: 'number' },
            'windowLayout.menuInfo.x': { label: 'Menu Info X', type: 'number' },
            'windowLayout.menuInfo.y': { label: 'Menu Info Y', type: 'number' },
            'windowLayout.menuInfo.w': { label: 'Menu Info W', type: 'number' },
            'windowLayout.menuInfo.h': { label: 'Menu Info H', type: 'number' },
            'windowLayout.menuRight.x': { label: 'Menu Right X', type: 'number' },
            'windowLayout.menuRight.y': { label: 'Menu Right Y', type: 'number' },
            'windowLayout.menuRight.w': { label: 'Menu Right W', type: 'number' },
            'windowLayout.menuRight.h': { label: 'Menu Right H', type: 'number' },
            'windowLayout.targetSelect.x': { label: 'Target Select X', type: 'number' },
            'windowLayout.targetSelect.y': { label: 'Target Select Y', type: 'number' },
            'windowLayout.targetSelect.w': { label: 'Target Select W', type: 'number' },
            'windowLayout.targetSelect.h': { label: 'Target Select H', type: 'number' },
            'windowLayout.targetInfo.x': { label: 'Target Info X', type: 'number' },
            'windowLayout.targetInfo.y': { label: 'Target Info Y', type: 'number' },
            'windowLayout.targetInfo.w': { label: 'Target Info W', type: 'number' },
            'windowLayout.targetInfo.h': { label: 'Target Info H', type: 'number' },
            'windowLayout.equipMain.x': { label: 'Equip Main X', type: 'number' },
            'windowLayout.equipMain.y': { label: 'Equip Main Y', type: 'number' },
            'windowLayout.equipMain.w': { label: 'Equip Main W', type: 'number' },
            'windowLayout.equipMain.h': { label: 'Equip Main H', type: 'number' },
            'windowLayout.equipSlot.x': { label: 'Equip Slot X', type: 'number' },
            'windowLayout.equipSlot.y': { label: 'Equip Slot Y', type: 'number' },
            'windowLayout.equipSlot.w': { label: 'Equip Slot W', type: 'number' },
            'windowLayout.equipSlot.h': { label: 'Equip Slot H', type: 'number' },
            'windowLayout.craftingHeader.x': { label: 'Crafting Header X', type: 'number' },
            'windowLayout.craftingHeader.y': { label: 'Crafting Header Y', type: 'number' },
            'windowLayout.craftingHeader.w': { label: 'Crafting Header W', type: 'number' },
            'windowLayout.craftingHeader.h': { label: 'Crafting Header H', type: 'number' },
            'windowLayout.craftingLeft.x': { label: 'Crafting Left X', type: 'number' },
            'windowLayout.craftingLeft.y': { label: 'Crafting Left Y', type: 'number' },
            'windowLayout.craftingLeft.w': { label: 'Crafting Left W', type: 'number' },
            'windowLayout.craftingLeft.h': { label: 'Crafting Left H', type: 'number' },
            'windowLayout.craftingRight.x': { label: 'Crafting Right X', type: 'number' },
            'windowLayout.craftingRight.y': { label: 'Crafting Right Y', type: 'number' },
            'windowLayout.craftingRight.w': { label: 'Crafting Right W', type: 'number' },
            'windowLayout.craftingRight.h': { label: 'Crafting Right H', type: 'number' },
            'windowLayout.craftingTop.x': { label: 'Crafting Top X', type: 'number' },
            'windowLayout.craftingTop.y': { label: 'Crafting Top Y', type: 'number' },
            'windowLayout.craftingTop.w': { label: 'Crafting Top W', type: 'number' },
            'windowLayout.craftingTop.h': { label: 'Crafting Top H', type: 'number' },
            'windowLayout.craftingInvLeft.x': { label: 'Crafting Inv Left X', type: 'number' },
            'windowLayout.craftingInvLeft.y': { label: 'Crafting Inv Left Y', type: 'number' },
            'windowLayout.craftingInvLeft.w': { label: 'Crafting Inv Left W', type: 'number' },
            'windowLayout.craftingInvLeft.h': { label: 'Crafting Inv Left H', type: 'number' },
            'windowLayout.craftingInvRight.x': { label: 'Crafting Inv Right X', type: 'number' },
            'windowLayout.craftingInvRight.y': { label: 'Crafting Inv Right Y', type: 'number' },
            'windowLayout.craftingInvRight.w': { label: 'Crafting Inv Right W', type: 'number' },
            'windowLayout.craftingInvRight.h': { label: 'Crafting Inv Right H', type: 'number' },
            'windowLayout.craftingConfirm.x': { label: 'Crafting Confirm X', type: 'number' },
            'windowLayout.craftingConfirm.y': { label: 'Crafting Confirm Y', type: 'number' },
            'windowLayout.craftingConfirm.w': { label: 'Crafting Confirm W', type: 'number' },
            'windowLayout.craftingConfirm.h': { label: 'Crafting Confirm H', type: 'number' },
            'windowLayout.craftingProgress.x': { label: 'Crafting Progress X', type: 'number' },
            'windowLayout.craftingProgress.y': { label: 'Crafting Progress Y', type: 'number' },
            'windowLayout.craftingProgress.w': { label: 'Crafting Progress W', type: 'number' },
            'windowLayout.craftingProgress.h': { label: 'Crafting Progress H', type: 'number' },
            'windowLayout.craftingResult.x': { label: 'Crafting Result X', type: 'number' },
            'windowLayout.craftingResult.y': { label: 'Crafting Result Y', type: 'number' },
            'windowLayout.craftingResult.w': { label: 'Crafting Result W', type: 'number' },
            'windowLayout.craftingResult.h': { label: 'Crafting Result H', type: 'number' },
