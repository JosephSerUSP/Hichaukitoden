        ...
        const CONFIG_SCHEMA = {
            ...
            'windowLayout.bgW': { label: 'Window Background Width (px)' },
            'windowLayout.bgH': { label: 'Window Background Height (px)' },
            'windowLayout.edgeOffset': { label: 'Window Edge Offset (px)' },
            'windowLayout.borderW': { label: 'Window Border Width (px)' },
            'windowLayout.headerSpacing': { label: 'Window Header Spacing (px)' },
            'windowLayout.headerXOffset': { label: 'Window Header X Offset (px)' },
            'windowLayout.headerYOffset': { label: 'Window Header Y Offset (px)' },
            'windowLayout.bgStartX': { label: 'Background Sprite Start X' },
            'windowLayout.bgStartY': { label: 'Background Sprite Start Y' },
            'windowLayout.edgeTopX': { label: 'Top Edge Sprite X' },
            'windowLayout.edgeTopY': { label: 'Top Edge Sprite Y' },
            'windowLayout.edgeTopW': { label: 'Top Edge Sprite W' },
            'windowLayout.edgeTopH': { label: 'Top Edge Sprite H' },
            'windowLayout.edgeBotX': { label: 'Bottom Edge Sprite X' },
            'windowLayout.edgeBotY': { label: 'Bottom Edge Sprite Y' },
            'windowLayout.edgeBotW': { label: 'Bottom Edge Sprite W' },
            'windowLayout.edgeBotH': { label: 'Bottom Edge Sprite H' },
            'windowLayout.edgeLeftX': { label: 'Left Edge Sprite X' },
            'windowLayout.edgeLeftY': { label: 'Left Edge Sprite Y' },
            'windowLayout.edgeLeftW': { label: 'Left Edge Sprite W' },
            'windowLayout.edgeLeftH': { label: 'Left Edge Sprite H' },
            'windowLayout.edgeRightX': { label: 'Right Edge Sprite X' },
            'windowLayout.edgeRightY': { label: 'Right Edge Sprite Y' },
            'windowLayout.edgeRightW': { label: 'Right Edge Sprite W' },
            'windowLayout.edgeRightH': { label: 'Right Edge Sprite H' },
            'windowLayout.cornerTlX': { label: 'Top-Left Corner Sprite X' },
            'windowLayout.cornerTlY': { label: 'Top-Left Corner Sprite Y' },
            'windowLayout.cornerTrX': { label: 'Top-Right Corner Sprite X' },
            'windowLayout.cornerTrY': { label: 'Top-Right Corner Sprite Y' },
            'windowLayout.cornerBlX': { label: 'Bottom-Left Corner Sprite X' },
            'windowLayout.cornerBlY': { label: 'Bottom-Left Corner Sprite Y' },
            'windowLayout.cornerBrX': { label: 'Bottom-Right Corner Sprite X' },
            'windowLayout.cornerBrY': { label: 'Bottom-Right Corner Sprite Y' },
            'windowLayout.cornerSize': { label: 'Corner Sprite Size (px)' }
        };
