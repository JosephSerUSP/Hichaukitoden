        ...
        var mapPropsEncounters = [];
        var mapPropsDirty = false;
...
window.getMapCategory = getMapCategory;
window.makeMapTreeItem = makeMapTreeItem;
window.makeTreeFolder = makeTreeFolder;
window.renderMapTree = renderMapTree;
window.getCachedImage = getCachedImage;
window.loadActiveMap = loadActiveMap;
window.renderGridCells = renderGridCells;
window.initCanvasEvents = initCanvasEvents;
window.pasteEventAt = pasteEventAt;
window.showCanvasContextMenu = showCanvasContextMenu;
window.paintCellAt = paintCellAt;
window.setPlayerStartPosition = setPlayerStartPosition;
window.setPaintTool = setPaintTool;
window.openMapProperties = openMapProperties;
window.closeMapPropertiesModal = closeMapPropertiesModal;
window.togglePropGenMode = togglePropGenMode;
window.renderEncountersList = renderEncountersList;
window.addEncounterToMap = addEncounterToMap;
window.removeEncounterFromMap = removeEncounterFromMap;
window.saveMapProperties = saveMapProperties;
window.createNewMap = createNewMap;
window.deleteMap = deleteMap;
window.openAssetPickerForBgm = openAssetPickerForBgm;
window.openAssetPicker = openAssetPicker;
window.loadAssetPickerFiles = loadAssetPickerFiles;
window.renderAssetPickerFiles = renderAssetPickerFiles;
window.applyAssetSelection = applyAssetSelection;
window.closeAssetPicker = closeAssetPicker;
window.showMapContextMenu = showMapContextMenu;
window.handleMapContextMenuAction = handleMapContextMenuAction;
