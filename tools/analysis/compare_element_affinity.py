#!/usr/bin/env python3
"""Deterministic Phase-1 comparison for Second Rite issue #168.

This tool does not change live combat data or runtime math. It reads the current
element graph and tuning values, evaluates representative matchups through the
current implementation and three general alternatives, then writes reviewable
...
4. **Weighted signed / joint** is the deliberately more radical comparison. It
   ...
   current skill curve. One innate relation is weighted at **{weight:.3f}** of one
