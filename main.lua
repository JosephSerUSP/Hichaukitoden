...
runValidation = function()
    ...
    local validateCommands -- forward declaration

    local function validateParam(cmdDef, paramDef, val, hostCtx, isImmediate, allowScript, ownerDesc, id)
        ...
        for _, cmd in ipairs(cmds or {}) do
            ...
            if cmdDef then
                ...
                for _, paramDef in ipairs(cmdDef.params or {}) do
                    ...
                    validateParam(cmdDef, paramDef, val, hostCtx, isImmediate, allowScript, ownerDesc, id)
                    end
                end
            end
