...
runValidation = function()
    ...
    local function validateCommandParam(id, cmdDef, paramDef, val, hostCtx, isImmediate, allowScript, ownerDesc)
        ...
        for _, cmd in ipairs(cmds or {}) do
            ...
            if cmdDef then
                ...
                for _, paramDef in ipairs(cmdDef.params or {}) do
                    ...
                    if val ~= nil then
                        validateCommandParam(id, cmdDef, paramDef, val, hostCtx, isImmediate, allowScript, ownerDesc)
                    end
                end
            end
