...
runValidation = function()
    ...
    local function validateCommandParam(val, paramDef, id, cmdDef, hostCtx, isImmediate, allowScript, ownerDesc)
    ...
    validateCommands = function(cmds, hostCtx, isImmediate, allowScript, ownerDesc)
        for _, cmd in ipairs(cmds or {}) do
            ...
            if cmdDef then
                ...
                for _, paramDef in ipairs(cmdDef.params or {}) do
                    ...
                    validateCommandParam(val, paramDef, id, cmdDef, hostCtx, isImmediate, allowScript, ownerDesc)
                end
            end
