...
runValidation = function()
    ...
    local function validateCommandParam(val, paramDef, cmdDef, id, ownerDesc, hostCtx, isImmediate, allowScript, validateCommands)
    ...
    local function validateCommands(cmds, hostCtx, isImmediate, allowScript, ownerDesc)
        for _, cmd in ipairs(cmds or {}) do
            ...
            if cmdDef then
                ...
                validateCommandParam(val, paramDef, cmdDef, id, ownerDesc, hostCtx, isImmediate, allowScript, validateCommands)
                    end
                end
            end
