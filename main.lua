...
runValidation = function()
    ...
    local function validateParam(id, cmdDef, paramDef, val, hostCtx, isImmediate, allowScript, ownerDesc)
            ...
            if cmdDef then
                ...
                for _, paramDef in ipairs(cmdDef.params or {}) do
                    ...
                    if val ~= nil then
                        ...
                        validateParam(id, cmdDef, paramDef, val, hostCtx, isImmediate, allowScript, ownerDesc)
                    end
                end
            end
